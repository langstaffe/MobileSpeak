...
internal object UiIcons {
    ...
    val Check = icon("Check", "M4 12L9.5 17.5L20 6")
    ...
    val Headphones = icon("Headphones",
        outline = "M3.8 21.2C2.3 18.3 1.4 15.4 1.4 12.5C1.4 6.1 5.9 1.4 12 1.4C18.1 1.4 22.6 6.1 22.6 12.5C22.6 15.4 21.7 18.3 20.2 21.2",
        fill = "M2.7 17.7C2.3 16.4 2.9 15.2 4.2 14.9C5.5 14.5 6.6 15.2 6.9 16.5L8.4 21.1C8.8 22.4 8.1 23.5 6.8 23.8C5.5 24.1 4.4 23.4 4.1 22.1Z M21.3 17.7C21.7 16.4 21.1 15.2 19.8 14.9C18.5 14.5 17.4 15.2 17.1 16.5L15.6 21.1C15.2 22.4 15.9 23.5 17.2 23.8C18.5 24.1 19.6 23.4 19.9 22.1Z",
        strokeWidth = 1.9f)
